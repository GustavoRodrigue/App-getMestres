...
import { SubCategoryController } from "./controller/SubCategoryContoller";
...
import { RequestOrderAnswerController } from "./controller/RequestOrderAnswerContoller";
//import { QuestionController } from "./controller/SubCategoryContoller";
...
export const Routes = [
    ...
    { method: "post", route: "/custumer", controller: CustomerController, action: "save" }, 
